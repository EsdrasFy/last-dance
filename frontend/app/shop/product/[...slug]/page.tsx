...
function Page({ params }: any) {
  ...
  return (
    <section className="h-full mt-28 mb-28 bg-custom-grayTwo max-w-[1050px] w-full mx-12 max-md:mx-2 p-4 shadow-snipped text-custom-textColor">
        ...
        <div className="flex w-full justify-between max-md:flex-col max-md:gap-3">
          ...
          <div className="flex justify-between font-normal gap-12">
                <div className="flex items-center gap-3">
                  ...
                  <span className="flex gap-1"> | <span className="text-custom-pink">107</span></span>
                </div>
